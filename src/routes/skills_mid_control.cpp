...
void skills_mid_control() {
    ...
    move_time(5000, 6000, 2000)
        ...
        .queue();
    move_point({-40, -65}, 2000, {.cutoff = 6.0, .drive_max_volt_pct = 30})
    ...
    turn_point({0, 0}, 800, {.reverse = true})
        .queue();
    move_pose({-8, -8}, -135, 2000, {.reverse = true, .max_vel_pct = 40})
        .start([]() { loader_piston.set_value(true); })
        .event(elapsed(200, []() { intake.set(-6000, -2000); }))
        .event(elapsed(400, []() { intake.stop(); }))
    ...
    turn_point({0, 0}, 300, {.reverse = true})
        ...
        .queue();
    wait(1000)
        .start([]() { intake.set_top_velocity(200);})
        .queue();
    ...
    turn_point({-48, 24}, 800, {.reverse = true}).queue();
